...
contains
  ...
  subroutine chemini &
    ...
    use mo_part_mercury,   only : parthg_inti 
    use mo_part_mercury_b, only : parthgb_inti
    use mo_rgm_seasalt_uptake, only : rgm_seasalt_uptake_inti
